...
//
//					String result = HttpUtil.post("http://127.0.0.1:8044/sso/login", map, 3000, 3000, "UTF-8");
...
//		String result = HttpUtil.post("http://127.0.0.1:8044/sso/sendEmail", map, 3000, 3000, "UTF-8");
//		System.out.println(result);
//
//	}
